        ...
        Thread thread = new Thread(new Runnable(){
            public void run() {
                try {
                    ...
                    service.setUsernameAndPassword("6bd102c9-ae3d-4c4c-b10e-91b8d3928dbb", "m2djJF81m6rC");
                    MessageRequest newMessage = new MessageRequest.Builder().inputText(inputmessage).context(context).build();
                    MessageResponse response = service.message("6e734d75-a2d2-41a9-af26-aad972617507", newMessage).execute();
